...
export const contactFaqs = [
  {
    question: "Quel type d'habitat est compatible ?",
    answer:
      "Le Nomad 01 est pense pour les vans, tiny houses et petits chalets, sous reserve d'une installation conforme."
  },
  {
    question: "Proposez-vous un accompagnement installation ?",
    answer:
      "Oui. Nous pouvons relire votre projet avec vous afin de valider l'implantation, le conduit et les distances de securite."
  }
];

export const atelierDetails = {
  city: "Lorient",
  address: ["1280 route des Sommets", "56100 Lorient", "France"],
  email: "bonjour@hearth.example",
  phone: "+33 4 80 00 00 00"
};
...
export const modelUsageGuide = [
  ...
  },
  {
    ...
    useCase: "Tiny houses avec hauteur sous plafond plus genereuse",
    description:
      "Une silhouette plus verticale, pensee pour gagner en rayonnement et en presence dans les volumes plus hauts."
  },
  {
    name: upcomingProducts[1].name,
    status: upcomingProducts[1].status,
    useCase: "Interieurs premium et projets sur mesure",
    description:
      "Une interpretation plus minerale et plus enveloppante pour les lieux qui veulent allier chaleur et presence decorative."
  }
];
...
export const extendedFaqs = [
  {
    ...
    answer:
      "Chaque commande est preparee avec soin, emballee pour le transport et expediee avec suivi vers la France et une grande partie de l'Europe."
  },
  {
    question: "Quel entretien prevoir ?",
    answer:
      "Un vidage regulier des cendres, un nettoyage de vitre adapte et une verification periodique du conduit suffisent a conserver un fonctionnement propre."
  },
  {
    question: "Y a-t-il une garantie ?",
    answer:
      "Oui. Les appareils sont couverts contre les defauts de fabrication et nous restons disponibles pour accompagner la mise en service."
  },
  {
    question: "Quel combustible utiliser ?",
    answer:
      "Un bois sec, bien stocke et de section adaptee reste indispensable pour obtenir une combustion stable et limiter l'encrassement."
  }
];
